...
?>
        ...
        <form method='POST' action='../core/core.clientes.insert.php'>
            ...
            <div class="md-form">
                ...
                <input name="id" type="text" id="id" value="0101199702810" class="form-control"  style="text-transform:uppercase" placeholder="0101-1997-02810" required>
            </div>
            <!-- Material input text -->
            <div class="md-form">
                <i class="fa fa-user prefix grey-text"></i>
                <label for="materialFormCardNameEx" class="font-weight-light">Nombre Completo</label>
                <input name="nombre" type="text" id="materialFormCardNameEx" value="FAVIO JAVIER ERAZO " class="form-control"  style="text-transform:uppercase" placeholder="FAVIO JAVIER ERAZO PINEDA" required>
            </div>
            <!--Genero -->
            <div class="md-form">
            ...
            <div class="md-form">
                ...
                <input name="correo" type="email" id="materialFormCardEmailEx" class="form-control" value="ferazo@credisol.hn" required>
            </div>
            ...
            <div class="md-form">
                ...
                <input name="tel" type="text" id="tel" class="form-control"  style="text-transform:uppercase" value="94453053" placeholder="9445-3053" ><i type="submit" style='font-size:24px;color:green' class="fa fa-plus font-weight-light  btn btn-info" onclick="return add_li()" value="Añadir"></i>
            ...
            <div class="md-form">
                ...
                <textarea name="direccion" type="text" class="form-control" rows="3" value="Barrio Ingles" onKeyPress="return coma(event)" required>Barrio Ingles Avenida Cabañas atras de la iglesia catolica san vicente de paul, atras de la pulperia las tres hermanas casa color verde porton negro.</textarea>
            </div>
