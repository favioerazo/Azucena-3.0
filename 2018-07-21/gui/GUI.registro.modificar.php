    ...
    <div class="modal-dialog">
      ...
      <div class="card mb-3" id="paso1" hidden >
        ...
        <div class="card-body">
          ...
          <input class="form-control " value="2395000001" type="number" id="clienteregistro"  placeholder="Numero de Orden"> </input> <i class="fa fa-cloud-download btn btn-primary" data-toggle="modal"  onclick="cargaDatosOrden()" data-target="#clientemodal2"> CARGAR</i><br>
      ...
      <div class="card mb-3" id="paso2" >
        ...
        <div class="card-body">
          <div class="form-control">
            ...
            <input class="btn btn-success" onclick="verifica();" value="Ingresar"  type="button" data-toggle="modal" data-target="#registromodal"></input ><br>
