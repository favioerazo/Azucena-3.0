    ...
    <div class="modal-dialog">
      ...
      <div class="card mb-3" id="paso1"  >
        ...
        <!--<button  type="button" class="btn btn-success pull-rigth" value="SIGUIENTE"  id="btnsig1" data-toggle="modal"  data-target="#registroConfirmacion" onclick="cargarListadoOrdenes()" > CARGAR <i class="fa fa-toggle-right" ></i>
          ...
          <br>
          <button type="button" disabled class="btn btn-warning pull-rigth" value="atras" onclick="mostrarForm('2','1');" id=""><i class="fa fa-toggle-left"> </i></button>
      ...
      <div class="card mb-3" id="paso5"  style="background-color:#10C8BF;" hidden>
        <div class="card-header"><font color="white" >
...
-->
      ...
      <div class="card mb-3" id="paso6" hidden >
        ...
        <div class="card-body">
          ...
          <button type="submit" class="btn btn-warning pull-rigth" value="ATRAS" onclick="mostrarForm('5','6');" id="btnsig5" disabled> <i class="fa fa-toggle-left"></i></button>
      ...
      <div class="card mb-3" id="paso7" hidden >
        <div class="card-header">
          <i class="fa fa-check"> Orden de Ingreso</i>
        </div>
        <div class="card-body">
            <div class="md-form" id="finOrden">
              <CENTER class="btn-info"><p>La Solicitud de trabajo se ha asignado exitosamente, presione el boton debajo para imprimir la orden.</p></CENTER>
            </div>
          <!--<button type="submit" class="btn btn-warning pull-rigth" value="ATRAS" onclick="mostrarForm('5','6');" id="btnsig5" disabled> <i class="fa fa-toggle-left"></i></button>-->
          <CENTER>
            <a class="btn btn-success pull-rigth" href="../core/core.reporte_orden.php" target="_blank"
            onclick="window.open(this.href, this.target, 'width=800,height=800'); return false;" style="color:#FFFFFF" ; id="btnImprimeOrden">
              <i class="fa fa-fw fa fa-print" style="color:#FFFFFF" ;=""></i> Imprimir</a>
            </CENTER>
        </div>
      </div>
     ...
     <div class="modal-content">
       ...
       <div class="modal-footer">
         ...
         <button type="button" class="btn btn-success" onclick="verificaDatosInternos();" data-dismiss="modal" >Confirmar</button>
       </div>
     </div>
     </div>
     </div>
