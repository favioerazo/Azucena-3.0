    ...
    <div class="modal-dialog">
      ...
      <div class="card mb-3" id="paso1"  >
        ...
        <!--<button  type="button" class="btn btn-success pull-rigth" value="SIGUIENTE"  id="btnsig1" data-toggle="modal"  data-target="#registroConfirmacion" onclick="cargarListadoOrdenes()" > CARGAR <i class="fa fa-toggle-right" ></i>
          ...
          <button type="button" class="btn btn-info pull-rigth" value="SIGUIENTE" onclick="cargaObjetosForm(); mostrarForm('2','1'); " id="btnmodi" disabled> Modificar <i class="fa fa-toggle-right"></i></button>
          <div id="arreglo">
          </div>
        </div>
      </div><i> </i>
      ...
      <div class="card mb-3" id="paso3" hidden>
        <div class="card-header">
          <i class="fa fa-medkit"> 2. DATOS DE ASEGURADORA</i>
        </div>
        <div class="card-body">
      ...
      <div class="card mb-3" id="paso4" style="background-color:#4F5056;" hidden >
        ...
        <div class="card-body">
          ...
          <button type="button" class="btn btn-info pull-rigth" value="SIGUIENTE" onclick="cargaImagenesDaños();" id="btnsig4"> <i class="fa fa-toggle-right"></i></button>
        </div>
      </div>
      ...
      <div class="card mb-3" id="paso5" hidden style="background-color:#10C8BF;">
        ...
        <div class="card-body">
          ...
          <input class="form-control btn-primary" id="img-r-1" name="img-r-1" type="file" accept="image/jpg,image/png,image/jpeg,image/gif" </input><br> <button type="button" class="btn btn-info pull-rigth" value="guardar" onclick="valorImagen();" id="btnsig4"> <i class="fa fa-toggle-right"></i></button><hr/>
      ...
      <div class="card mb-3" id="paso6" hidden >
        ...
        <div class="card-body">
            ...
            <label><i class="fa fa-ambulance"></i> Costo Estimado (Lps) </label>  
          <input placeholder="0.00 Lps" class="form-control" type="number" ></input><br>
          ...
          <input class="form-control" placeholder="Detalle la forma de pago" type="text" id="txt-forma" hidden=""></input>
          ...
          <input  class="form-control" type="number" readOnly id="txt-adelanto" ></input><br>
          <hr>
            <label><i class="fa fa-ambulance"></i> Fecha Posible Entrega (AAAA-MM-DD)</label>  
          <input class="form-control date-own2" type="text" readonly=""></input><br>
          ...
          <div class="input-group">
          <input class="form-control " value="" type="text" id="clienteregistro" readonly placeholder=""> </input> <i class="fa fa-search btn btn-primary" readonly data-toggle="modal"  onclick="cargaDatosOrden()"  data-target=""></i><br>
          </div>
          <br>
          <br>
