      ...
      echo '<div class="container">
        ...
        <form action="core/core.login.php" method="post" >
              <div class="form-group">
                ...
                <input name="usuario" class="form-control" id="exampleInputEmail1" type="text" aria-describedby="emailHelp" placeholder="Ingrese Su Usuario" style="text-transform:uppercase" value="" required>
              </div>
              <div class="form-group">
                <label for="exampleInputPassword1">Contraseña</label>
                <input class="form-control" id="exampleInputPassword1" type="password" placeholder="Ingrese su Contraseña" name="pass" value="" required>
