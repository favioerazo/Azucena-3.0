...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-07-2018 a las 01:06:56
...
('1006000001', 'FAVIO JAVIER ERAZO PINEDA', '0101199702810', 'ferazo@credisol.hn', 'M', 'barrio ingles avenida caba?as atras de la iglesia catolica san vicente de paul atras de la pulperia las tres hermanas casa color verde porton negro.', '2018-07-23 16:24:47', '2018-07-23 16:25:44', 1);
...
(5, '0101199702810', '9532-6211'),
(6, '0101199702810', '9532-6210');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `dat_reg_aseguradora`
--

CREATE TABLE `dat_reg_aseguradora` (
  `c_registro` varchar(20) COLLATE latin1_spanish_ci NOT NULL,
  `d_empresa` varchar(100) COLLATE latin1_spanish_ci DEFAULT NULL,
  `c_reclamo` varchar(30) COLLATE latin1_spanish_ci DEFAULT NULL,
  `c_poliza` varchar(30) COLLATE latin1_spanish_ci DEFAULT NULL,
  `f_ingreso` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;

--
-- Volcado de datos para la tabla `dat_reg_aseguradora`
--

INSERT INTO `dat_reg_aseguradora` (`c_registro`, `d_empresa`, `c_reclamo`, `c_poliza`, `f_ingreso`) VALUES
('2395000001', NULL, NULL, NULL, '2018-07-23 16:27:42');
...
('img-d-1', '2395000001', 'frontal', '2018-07-23 16:38:08', '../imagenes/2395000001_img-d-1.jpg'),
('img-d-2', '2395000001', 'arriba', '2018-07-23 16:38:08', '../imagenes/2395000001_img-d-2.jpg'),
('img-d-3', '2395000001', 'abajo', '2018-07-23 16:38:08', '../imagenes/2395000001_img-d-3.jpg'),
('img-d-4', '2395000001', 'derecha', '2018-07-23 16:38:08', '../imagenes/2395000001_img-d-4.jpg'),
('img-d-5', '2395000001', 'izquierda', '2018-07-23 16:38:08', '../imagenes/2395000001_img-d-5.jpg'),
('img-r-1', '2395000001', '1', '2018-07-23 16:39:04', '../imagenes/2395000001_img-r-1.jpg'),
('img-r-2', '2395000001', '2', '2018-07-23 16:39:04', '../imagenes/2395000001_img-r-2.jpg'),
('img-r-3', '2395000001', '3', '2018-07-23 16:39:04', '../imagenes/2395000001_img-r-3.jpg'),
('img-r-4', '2395000001', '4', '2018-07-23 16:39:04', '../imagenes/2395000001_img-r-4.jpg'),
('img-r-5', '2395000001', '5', '2018-07-23 16:39:04', '../imagenes/2395000001_img-r-5.jpg');
...
('2395000001', '1006000001', '0101199702810', 'I', 'ROOT', NULL, '2018-07-23 16:27:41', '2018-07-23 16:27:41', 1);
...
('5807000001', '2395000001', 'TOYOTA', 'Hilux', '3.0', 'PICKUP', 'TCA2d1A', '2015', '9E9E9E', '120000', '50%', '2018-07-23 16:27:42', 1);
...
('01', '1006000001', 'SECUENCIA DE CLIENTES', 1),
...
(55080134, 'FERAZO', 'INGRESO', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/67.0.3396.99 Safari/537.36', '192.168.2.200', '2018-07-23 09:30:17'),
(55080135, 'FERAZO', 'SALIDA', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/67.0.3396.99 Safari/537.36', '192.168.2.200', '2018-07-23 09:41:12'),
(55080136, 'JREYES', 'INGRESO', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/67.0.3396.99 Safari/537.36', '192.168.2.200', '2018-07-23 09:41:15'),
(55080137, 'JREYES', 'SALIDA', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/67.0.3396.99 Safari/537.36', '192.168.2.200', '2018-07-23 10:59:02'),
(55080138, 'FERAZO', 'INGRESO', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/67.0.3396.99 Safari/537.36', '192.168.2.200', '2018-07-23 10:59:04'),
(55080139, 'FERAZO', 'SALIDA', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/67.0.3396.99 Safari/537.36', '192.168.2.200', '2018-07-23 11:42:37'),
(55080140, 'JREYES', 'INGRESO', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/67.0.3396.99 Safari/537.36', '192.168.2.200', '2018-07-23 11:42:44'),
(55080141, 'JREYES', 'SALIDA', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/67.0.3396.99 Safari/537.36', '192.168.2.200', '2018-07-23 11:45:12'),
(55080142, 'JREYES', 'INGRESO', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/67.0.3396.99 Safari/537.36', '192.168.2.200', '2018-07-23 11:45:16'),
(55080143, 'JREYES', 'SALIDA', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/67.0.3396.99 Safari/537.36', '192.168.2.200', '2018-07-23 14:23:26'),
(55080144, 'FERAZO', 'INGRESO', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/67.0.3396.99 Safari/537.36', '192.168.2.200', '2018-07-23 14:23:30'),
(55080145, 'FERAZO', 'SALIDA', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/67.0.3396.99 Safari/537.36', '192.168.2.200', '2018-07-23 16:12:50'),
(55080146, 'ROOT', 'INGRESO', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/67.0.3396.99 Safari/537.36', '192.168.2.200', '2018-07-23 16:12:53');
...
('JTURCIOS', 'JOSE RAMON TURCIOS GUTIERREZ', 'jturcios@credisol.hn', 'qwerty123', 1),
...
('JTURCIOS', '01', '0000-00-00 00:00:00', 1),
('JTURCIOS', '0103', '0000-00-00 00:00:00', 1),
('JTURCIOS', '02', '0000-00-00 00:00:00', 1),
('JTURCIOS', '0201', '0000-00-00 00:00:00', 1),
('JTURCIOS', '0202', '0000-00-00 00:00:00', 1),
('JTURCIOS', '03', '0000-00-00 00:00:00', 1),
('JTURCIOS', '0301', '0000-00-00 00:00:00', 1),
('JTURCIOS', '0302', '0000-00-00 00:00:00', 1),
('JTURCIOS', '04', '0000-00-00 00:00:00', 1),
('JTURCIOS', '05', '0000-00-00 00:00:00', 1),
('JTURCIOS', 'JTURCIOS', '0000-00-00 00:00:00', 1);
...
--
-- AUTO_INCREMENT de la tabla `dat_cli_telefono`
--
ALTER TABLE `dat_cli_telefono`
  MODIFY `c_registro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT de la tabla `dat_reg_vehiculo_objetos_adic`
--
ALTER TABLE `dat_reg_vehiculo_objetos_adic`
  MODIFY `c_objeto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33780016;
--
-- AUTO_INCREMENT de la tabla `sist_log_login`
--
ALTER TABLE `sist_log_login`
  MODIFY `c_registro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55080147;
