      ...
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Usuarios">
          ...
          <ul class="sidenav-second-level collapse" id="collapseUsuarios">
            <li>
              <a href="tables.php">Ingresar</a>
            </li>
            <li>
              <a href="tables.php">Modificar</a>
            </li>
            <li>
              <a href="tables.php">Opciones</a>
            </li>
          </ul>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="ControlAC">
          <a class="nav-link nav-link-collapse collapsed" data-toggle="collapse" href="#collapseControlAC" data-parent="#exampleAccordion">
            <i class="fa fa-fw fa-wrench"></i>
            <span class="nav-link-text">Control AC</span>
          </a>
          <ul class="sidenav-second-level collapse" id="collapseControlAC">
            <li>
              <a href="controlACforingreso.php">Ingresar</a>
            </li>
            <li>
              <a href="tables.php">Modificar</a>
            </li>
            <li>
              <a href="tables.php">Apagar/Encender</a>
            </li>
          </ul>
        </li>
    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Listado de AC</div>
        <div class="card-body">
