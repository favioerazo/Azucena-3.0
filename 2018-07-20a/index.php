      ...
      echo '<div class="container">
        ...
        <form action="core/core.login.php" method="post" >
              <div class="form-group">
                ...
                <input name="usuario" class="form-control" id="exampleInputEmail1" type="text" aria-describedby="emailHelp" placeholder="Ingrese Su Usuario" style="text-transform:uppercase" value="FERAZO" required>
              </div>
              <div class="form-group">
